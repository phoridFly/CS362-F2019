/*************************************************************************
 ...
 This file contains the test suite for the refactored "cardEffectMinion"
...
int main () {
    ...
    printf("Part 1: Choice = 1 (Gain +2 treasure)\n");
    ...
    printf("Part 2: Choice = 2 (Player discards and draws new hand)\n");
    ...
    printf("Part 3: Choice = 2 (Minion attack).\n");
    ...
    printf("Part 4: Choice = 2 (Checking the number of actions).\n");
    ...
    cardEffectMinion(0, 1, &testGame, handpos, currentPlayer);
