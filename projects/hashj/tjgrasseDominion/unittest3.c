/*************************************************************************
 ...
 This file contains the test suite for the refactored "processAmbassadorCard"
...
int main () {
    ...
    printf("Testing the function processAmbassadorCard():\n\n");
    ...
    int revealCard = 1;   // get rid of smithy card
    int returnCards = 1;   // get rid of 1 additional card
    int currentPlayer = 0;
    int handPos = 4;
    
    
    // call the function
    processAmbassadorCard(revealCard, returnCards, handPos, &testGame);

    printf("Part 1: revealCard = Smithy (Get rid of Smithy card in hand position 1) returnCards = 1 (Discard 1 copy of Smithy card)\n");
    ...
    printf("Part 2: revealCard = Smithy (Get rid of Smithy card in hand position 1) returnCards = 0 (Discard 0 copies of Smithy card)\n");
    ...
    // the choice to discard and draw a new hand
    revealCard = 1;   // get rid of smithy card
    returnCards = 0;   // get rid of 0 additional copies
    currentPlayer = 0;
    handPos = 4;
    ...
    printf("Part 3: revealCard = Hand Position\n");
    ...
    // the choice to discard and draw a new hand
    revealCard = 1;   // get rid of smithy card
    returnCards = 2;   // get rid of 2 additional copies
    currentPlayer = 0;
    handPos = 4;
    ...
    // the choice to discard and draw a new hand
    revealCard = 1;   // get rid of smithy card
    returnCards = 5;   // attempt to get rid of 5 copies of a card
    currentPlayer = 0;
    handPos = 4;
    int negativeOneReturn;

    // call the function
    negativeOneReturn = processAmbassadorCard(revealCard, returnCards, handPos, &testGame);
