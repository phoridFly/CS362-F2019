/*************************************************************************
 ...
 This file contains the test suite for the refactored "cardEffectBaron"
...
int main () {
    ...
    printf("Part 1: Choice = 1 (Player uses Baron to discard Estate card for +4 Treasure)\n");
    ...
    printf("Part 2: Choice = 0 (Player uses Baron to gain an Estate card)\n");
    ...
    printf("Part 3: Choice = 0 (Player uses Baron to gain the final Estate card in the Supply)\n");
